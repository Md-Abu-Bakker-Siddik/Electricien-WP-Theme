<?php
namespace MascotCoreElectricien\Widgets\Tabs\Skins;
...
class Skin_Left_Nav extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Left Nav', 'mascot-core-electricien' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'skin-left-nav-classic'	=> 	esc_html__( "Style Classic", 'mascot-core-electricien' ),
				],
				'default' => ''
			]
		);
	...
	public function register_layout_controls2( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'wrapper_styling',
			[
				'label' => esc_html__( 'Tab & Content Placement', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Tab & Content Flex Direction", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_disply_flex_direction_elementor(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'list_icon_options',
			[
				'label' => esc_html__( 'Icon Options (Tab)', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'translate-x'  => esc_html__( 'Translate X Left', 'mascot-core-electricien' ),
					'translate-x-right'  => esc_html__( 'Translate X Right', 'mascot-core-electricien' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Icon Typography', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			'hide_icon',
			[
				'label' => esc_html__( 'Hide Icon', 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Wrapper Dimension Options', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border/Shadow Options', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Icon Border', 'mascot-core-electricien' ),
				'selector' => '{{WRAPPER}} .tm-tabs-vertical-nav li .tabs-icon',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Border Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'list_icon_opacity',
			[
				'label' => esc_html__( 'Icon Opacity', 'mascot-core-electricien' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->start_controls_section(
			'list_styling',
			[
				'label' => esc_html__( 'Text Typography/Color  (Tab)', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper of Tab Blocks', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Wrapper Style', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Text Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
