<?php
namespace MascotCoreElectricien\Widgets\Tabs;
...
class TM_Elementor_Tabs extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-tabs-style', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/widgets-core/tabs' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'TM Tabs', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'expand',
			[
				'label' => esc_html__( "Make It Active/Expand?", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'tabs_tab_icon_type',
			[
				'label' => esc_html__( 'Add Icon/Image', 'mascot-core-electricien' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'' => [
						'title' => esc_html__( 'None', 'mascot-core-electricien' ),
						'icon' => 'fa fa-ban',
					],
					'font' => [
						'title' => esc_html__( 'Icon', 'mascot-core-electricien' ),
						'icon' => 'far fa-smile',
					],
					'image' => [
						'title' => esc_html__( 'Image', 'mascot-core-electricien' ),
						'icon' => 'fa fa-image',
					]
				],
				'default' => '',
		...
		$repeater->add_control(
			...
			[
				...
				'description' => esc_html__('Select icon from Fontawesome library.', 'mascot-core-electricien'),
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			'tabs_content_type',
			[
				'label' => esc_html__('Content Type', 'mascot-core-electricien'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'content' => esc_html__('Content', 'mascot-core-electricien'),
					'template' => esc_html__('Elementor Templates', 'mascot-core-electricien'),
				],
				'default' => 'content',
			]
		);
		$repeater->add_control(
			...
			[
				'label' => esc_html__('Choose Elementor Template', 'mascot-core-electricien'),
				'type' => Controls_Manager::SELECT,
				'options' => mascot_core_electricien_get_elementor_templates(),
				'condition' => [
		...
		$repeater->add_control(
			'tabs_content',
			[
				'label' => esc_html__('Tab Content', 'mascot-core-electricien'),
				'type' => Controls_Manager::WYSIWYG,
				'default' => esc_html__( "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.", 'mascot-core-electricien' ),
				'dynamic' => [ 'active' => true ],
				'condition' => [
		...
		$this->add_control(
			'tabs_items',
			[
				'label' => esc_html__( "Item", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'title_field' => '{{{ title }}}',
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => __( 'Title 1', 'mascot-core-electricien' ),
						'expand' => 'yes',
					],
					[
						'title' => __( 'Title 2', 'mascot-core-electricien' ),
					],
					[
						'title' => __( 'Title 3', 'mascot-core-electricien' ),
					],
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Block - Width/Alignment', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Horizontal Alignment", 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Each Tab Block Width", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Each Title + Icon/Image Alignment', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			'tabs_icon_position',
			[
				'label' => esc_html__('Icon/Image & Title Position', 'mascot-core-electricien'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'column' => [
		...
		$this->add_responsive_control(
			'title_flex_vertical',
			[
				'label' => esc_html__( "Title + Icon Vertical Alignment", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Title + Icon Horizontal Alignment", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_disply_flex_horizontal_align_elementor(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Block - Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Idle', 'mascot-core-electricien'),
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'title_block_margin',
			[
				'label' => esc_html__( 'Block Margin', 'mascot-core-electricien' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'title_block_padding',
			[
				'label' => esc_html__( 'Block Padding', 'mascot-core-electricien' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Block Border Radius", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Falling Shutter Height", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'default' => [
					'unit' => '%',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Color Options', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'title_styling',
			[
				'label' => esc_html__( 'Title (Tab)', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => '',
				],
		...
		$this->start_controls_section(
			'section_style_icon',
			[
				'label' => esc_html__('Icon (Tab)', 'mascot-core-electricien'),
		...
		$this->add_responsive_control(
			'tabs_icon_size',
			[
				'label' => esc_html__('Icon Font Size', 'mascot-core-electricien'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Icon Image Width', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 26,
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Content Background Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'dynamic' => [ 'active' => true ],
				'selectors' => [
	...
	protected function render() {
		...
		$settings['holder_id'] = mascot_core_electricien_get_isotope_holder_ID('tabs');
		...
		?>
			...
			<?php
				foreach (  $settings['tabs_items'] as $item ) {
					...
					$html .= mascot_core_electricien_get_widgetcore_template_part( 'tab-title', null, 'tabs/tpl', $settings, false );
					$i++;
				}
			?>
			</ul>
		...
		?>
			...
			<?php
				foreach (  $settings['tabs_items'] as $item ) {
					...
					//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
					$html .= mascot_core_electricien_get_widgetcore_template_part( 'tab-content', null, 'tabs/tpl', $settings, false );
					$i++;
				}
			?>
			</div>
