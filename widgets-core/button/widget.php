...
class TM_Elementor_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Read More", 'mascot-core-electricien' ),
			]
		);
		$this->add_control(
			'link',
		...
		//add button controns
		mascot_core_electricien_get_button_control($this);
		...
		$this->add_control(
			'add_icon',
			[
				'label' => esc_html__( "Show/Hide Icon?", 'mascot-core-electricien' ),
	...
	protected function render() {
		...
		$html = mascot_core_electricien_get_widgetcore_template_part( 'button', null, 'button/tpl', $settings, true );
