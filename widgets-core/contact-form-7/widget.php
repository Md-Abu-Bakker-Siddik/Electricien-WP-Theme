...
class TM_Elementor_Contact_Form_7 extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-contact-form-7-style', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/widgets-core/contact-form-7' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		if (!function_exists('wpcf7')) {
			$this->start_controls_section(
				'tm_global_warning',
				[
					'label' => esc_html__('Warning!', 'mascot-core-electricien'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw' => esc_html__('<strong>Contact Form 7</strong> is not installed/activated on your site. Please install and activate <strong>Contact Form 7</strong> first.', 'mascot-core-electricien'),
			...
			$this->start_controls_section(
				'section_info_box',
				[
					'label' => esc_html__('Contact Form', 'mascot-core-electricien'),
				]
			);
			$this->add_control(
				'contact_form_list',
				[
					'label' => esc_html__('Select Form', 'mascot-core-electricien'),
					'type' => Controls_Manager::SELECT,
					'label_block' => true,
					'options' => mascot_core_electricien_get_wpcf7_list(),
					'default' => '0',
				]
			);
			$this->add_control(
				'labels_switch',
				[
					'label' => esc_html__('Show Labels', 'mascot-core-electricien'),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'label_on' => esc_html__('Show', 'mascot-core-electricien'),
					'label_off' => esc_html__('Hide', 'mascot-core-electricien'),
					'return_value' => 'yes',
				]
			);
			$this->end_controls_section();
			...
			$this->add_control(
				'form_subtitle',
				[
					'label' => esc_html__('Form Sub Title', 'mascot-core-electricien'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'mascot-core-electricien'),
					'label_off' => esc_html__('Off', 'mascot-core-electricien'),
					'return_value' => 'yes',
				]
			);
			$this->add_control(
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( "Sub Title Position", 'mascot-core-electricien' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'above-title' => esc_html__( 'Above Title', 'mascot-core-electricien' ),
						'below-title' => esc_html__( 'Below Title', 'mascot-core-electricien' ),
					],
					'default' => 'above-title',
					'condition' => [
						'form_subtitle' => 'yes',
			...
			$this->add_control(
				'form_title',
				[
					'label' => esc_html__('Form Title', 'mascot-core-electricien'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'mascot-core-electricien'),
					'label_off' => esc_html__('Off', 'mascot-core-electricien'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__('Description', 'mascot-core-electricien'),
				]
			);
			$this->add_control(
				'form_description',
				[
					'label' => esc_html__('Form Description', 'mascot-core-electricien'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'mascot-core-electricien'),
					'label_off' => esc_html__('Off', 'mascot-core-electricien'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				'section_errors',
				[
					'label' => esc_html__('Errors', 'mascot-core-electricien'),
				]
			);
			...
			$this->add_control(
				'error_messages',
				[
					'label' => esc_html__('Error Messages', 'mascot-core-electricien'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'mascot-core-electricien'),
			...
			$this->add_control(
				'validation_errors',
				[
					'label' => esc_html__('Validation Errors', 'mascot-core-electricien'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'mascot-core-electricien'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Form Container', 'mascot-core-electricien'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Alignment', 'mascot-core-electricien'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'default' => [
						'title' => esc_html__('Default', 'mascot-core-electricien'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Max Width', 'mascot-core-electricien'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Padding', 'mascot-core-electricien'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Title & Description', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'heading_alignment',
			[
				'label' => esc_html__('Alignment', 'mascot-core-electricien'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__('Left', 'mascot-core-electricien'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Heading Wrapper Style', 'mascot-core-electricien' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Wrapper Style', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Only Select/Dropdown Field', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Dropdown Arrow Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Placeholder Text Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Input, Select & Textarea', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Background Theme Color', 'mascot-core-electricien'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'text_indent',
			[
				'label' => esc_html__('Text Indent', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_width',
			[
				'label' => esc_html__('Input Width', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_height',
			[
				'label' => esc_html__('Input Height', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_width',
			[
				'label' => esc_html__('Textarea Width', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_height',
			[
				'label' => esc_html__('Textarea Height', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_tab(
			'tab_fields_focus',
			[
				'label' => esc_html__('Focus', 'mascot-core-electricien'),
			]
		);
		...
		$this->start_controls_section(
			'section_label_style',
			[
				'label' => esc_html__('Labels', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'labels_switch' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'raw' => esc_html__('if label spacing doesn\'t worked, please update label display', 'mascot-core-electricien'),
				'content_classes' => 'tm-warning',
			]
		);
		$this->add_control(
			'label_disply_type',
			[
				'label' => esc_html__('Display', 'mascot-core-electricien'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
		...
		$this->add_responsive_control(
			'label_spacing',
			[
				'label' => esc_html__('Spacing', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Placeholder', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'placeholder_switch',
			[
				'label' => esc_html__('Show Placeholder', 'mascot-core-electricien'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_on' => esc_html__('Yes', 'mascot-core-electricien'),
				'label_off' => esc_html__('No', 'mascot-core-electricien'),
				'return_value' => 'yes',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Radio & Checkbox', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Custom Styles', 'mascot-core-electricien'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'mascot-core-electricien'),
				'label_off' => esc_html__('No', 'mascot-core-electricien'),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'radio_checkbox_size',
			[
				'label' => esc_html__('Size', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '15',
					'unit' => 'px',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Border Width', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'checkbox_heading',
			[
				'label' => esc_html__('Checkbox', 'mascot-core-electricien'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->add_control(
			'radio_heading',
			[
				'label' => esc_html__('Radio Buttons', 'mascot-core-electricien'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Checked', 'mascot-core-electricien'),
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => 'custom',
				'options' => [
					'full-width' => esc_html__('Full Width', 'mascot-core-electricien'),
					'custom' => esc_html__('Custom', 'mascot-core-electricien'),
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button Position', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			'spinner_icon_style',
			[
				'label' => esc_html__('After Submit Spinner Icon', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_wpcf7_spinner',
			[
				'label' => esc_html__( 'Hide Spinner Icon', 'mascot-core-electricien' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Progress Range Styling (Optional)', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Label/Title Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Label/Title Typography', 'mascot-core-electricien'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Amount Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-contact-form-7 .uacf7-amount' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Amount Typography', 'mascot-core-electricien'),
				'selector' => '{{WRAPPER}} .tm-contact-form-7 .uacf7-amount',
				'separator' => 'before',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Progress Background Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-contact-form-7 .ui-widget.ui-widget-content .ui-widget-header' => 'background-color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Background Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-contact-form-7 .ui-widget.ui-widget-content' => 'background-color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Bar Border', 'mascot-core-electricien'),
				'selector' => '{{WRAPPER}} .ui-widget.ui-widget-content',
			]
		);
		$this->add_control(
			'progress_range_bar_handle_bg_color',
			[
				'label' => esc_html__('Bar Handle Background Color', 'mascot-core-electricien'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .tm-contact-form-7 .ui-slider-handle' => 'background-color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name' => 'progress_range_bar_handle_border',
				'label' => esc_html__('Bar Handle Border', 'mascot-core-electricien'),
				'selector' => '{{WRAPPER}} .tm-contact-form-7 .ui-state-default:before',
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Alert', 'mascot-core-electricien'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Fields', 'mascot-core-electricien'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_section(
			'ajaxloader_style',
			[
				'label' => esc_html__('Ajax Loader Image', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_ajaxloader',
			[
				'label' => esc_html__('Hide Ajax Loader Image', 'mascot-core-electricien'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('After Submit Feedback', 'mascot-core-electricien'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Radius', 'mascot-core-electricien'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
	...
	protected function render2() {
		...
		//$html = mascot_core_electricien_get_widgetcore_template_part( 'wpcf7', null, 'wpcf7/tpl', $settings, true );
