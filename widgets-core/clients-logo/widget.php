...
class TM_Elementor_Clients_logo extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-clients-logo-style', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/widgets-core/clients-logo' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Clients Logo', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'tm_items_section',
			[
				'label' => esc_html__( 'Items', 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'logo', [
				'label' => esc_html__( "Logo", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'logo_url',
			[
				'label' => esc_html__( "URL", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'link_target', [
				...
				'options' => [
					'_blank'  =>  esc_html__( 'Opens in a new window or tab', 'mascot-core-electricien' ),
					'_self' =>  esc_html__( 'Opens in the same window', 'mascot-core-electricien' ),
				],
				'default' => '_blank'
			]
		);
		$this->add_control(
			'clients_logo_array',
			[
				'label' => esc_html__( "Clients Logo", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Hover Animation Type", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'clients-animation-no-effect' =>  esc_html__( 'No Effect', 'mascot-core-electricien' ),
					'clients-animation-grayscale' =>  esc_html__( 'Grayscale Effect', 'mascot-core-electricien' ),
					'clients-animation-opacity' =>  esc_html__( 'Opacity Effect', 'mascot-core-electricien' ),
					'clients-animation-blur'  =>  esc_html__( 'Blur Effect', 'mascot-core-electricien' ),
					'clients-animation-zoom'  =>  esc_html__( 'Zoom Effect', 'mascot-core-electricien' ),
					'clients-animation-contrast'  =>  esc_html__( 'Contrast Effect', 'mascot-core-electricien' ),
					'clients-animation-invert'  =>  esc_html__( 'Invert Effect', 'mascot-core-electricien' ),
				],
		...
		$this->add_control(
			'rollover_effect',
			[
				'label' => esc_html__( "Make Roll Over Effect", 'mascot-core-electricien' ),
		...
		$this->add_control(
			'logo_filter_options',
			[
				'label' => esc_html__( 'Filter Options', 'mascot-core-electricien' ),
		...
		$this->start_controls_section(
			'each_logo_styling',
			[
				'label' => esc_html__( 'Each Logo Styling', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Vertical Alignment", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Horizontal Alignment", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => esc_html__( 'Column Gap', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Area Custom Width", 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo/Image Custom Width", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units' => [ 'px', '%' ],
				'default' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('First Child', 'mascot-core-electricien'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Last Child', 'mascot-core-electricien'),
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		$html = mascot_core_electricien_get_widgetcore_template_part( 'clients', $settings['display_type'], 'clients-logo/tpl', $settings, true );
