...
class TM_Elementor_BG_Aangle_Left_Right extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-bg-angle-left-right-style', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/widgets-core/bg-angle-left-right' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Bg Aangle Left Right', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'hide_under_1201',
			[
				'label' => esc_html__( "Hide Under 1201px", 'mascot-core-electricien' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Top Options', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Border Top Width", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Top Color", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Top Theme Colored", 'mascot-core-electricien' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Right Options', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Border Right Width", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Right Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Right Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Bottom Options', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Border Bottom Width", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Bottom Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Border Left Options', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Border Left Width", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Left Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Border Left Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
	...
	$html = mascot_core_electricien_get_widgetcore_template_part( 'bg-angle-left-right', null, 'bg-angle-left-right/tpl', $settings, true );
