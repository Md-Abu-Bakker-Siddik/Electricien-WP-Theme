<?php
namespace MascotCoreElectricien\CPT;

use MascotCoreElectricien\Lib;

/**
 * class Reg_Post_Type
 * @package MascotCoreElectricien\CPT;
 */
class Reg_Post_Type {
	/**
	 ...
	 */
	private function add_new_post_type(Lib\Mascot_Core_Electricien_Interface_PostType $newPostType) {
...
add_action('elementor/init','MascotCoreElectricien\CPT\tm_enable_elementor_for_all_cpt');