<?php
namespace MascotCoreElectricien\CPT\PageTitle;
 ...
 * Singleton class
 * class CPT_PageTitle
 * @package MascotCoreElectricien\CPT\PageTitle;
 */
final class CPT_PageTitle implements Lib\Mascot_Core_Electricien_Interface_PostType {
	 ...
	 *
	 * @return CPT_PageTitle
	 */
	public static function Instance() {
		static $inst = null;
		if ($inst === null) {
			$inst = new CPT_PageTitle();
		}
		return $inst;
	}
	...
	private function __construct() {
		$this->ptSingularName = esc_html__( 'Parts - Page Title', 'mascot-core-electricien' );
		$this->ptPluralName = esc_html__( 'Parts - Page Title', 'mascot-core-electricien' );
		$this->ptKey = 'page-title';
	...
	public function customColumnsSettings( $columns ) {
		...
		$columns = array(
			...
			'active-page-title'	=> esc_html__( 'Currently Active Page Title', 'mascot-core-electricien' ),
	...
	public function customColumnsContent( $columns ) {
		global $post;
		switch( $columns ) {
			case 'active-page-title' :
				if( mascot_core_electricien_theme_installed() ) {
					$active_headertop_id = electricien_get_redux_option( 'page-title-settings-choose-page-title-cpt-widget-area', 'default' );
