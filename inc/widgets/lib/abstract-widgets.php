...
/**
 * abstract class Mascot_Core_Electricien_Widget_Loader
 */
if( !class_exists( 'Mascot_Core_Electricien_Widget_Loader' ) ) {
abstract class Mascot_Core_Electricien_Widget_Loader extends WP_Widget {
		...
		foreach( $this->formFields as $eachFormField ) {
			...
			?>
				...
				<div class="tm-widget-image-field">
					...
					<br>
					<br>
					<a class="button tm-widget-image-upload" data-target="#<?php echo esc_attr( $this->get_field_id( $eachFormField['id'] ) ); ?>" data-preview=".tm-widget-preview-image" data-frame="select" data-state="wpc_widgets_insert_single" data-fetch="url" data-title="Insert Image" data-button="Insert" data-class="media-frame tm-widget-custom-uploader" title="Add Media"><?php echo esc_html__( 'Add Media', 'mascot-core-electricien' ); ?></a>

					<a class="button tm-widget-delete-image" data-target="#<?php echo esc_attr( $this->get_field_id( $eachFormField['id'] ) ); ?>" data-preview=".tm-widget-preview-image"><?php echo esc_html__( 'Delete', 'mascot-core-electricien' ); ?></a>
			...
			?>
				<p>
				<?php esc_html_e( 'Error! Undefined field Type.', 'mascot-core-electricien' ); ?>
				</p>
			<?php
			break;
			}
			...
			<p><?php esc_html_e( 'No options found for this widget!', 'mascot-core-electricien' ); ?></p>
		<?php }
	}
}
}