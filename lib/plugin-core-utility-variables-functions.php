...
if(!function_exists('mascot_core_electricien_theme_color_list')) {
	/**
	 * Theme Color list
	 */
	function mascot_core_electricien_theme_color_list() {
		$theme_color_list = array(
			'' => esc_html__( 'No', 'mascot-core-electricien' ),
			'1' => esc_html__( 'Theme Color 1', 'mascot-core-electricien' ),
			'2' => esc_html__( 'Theme Color 2', 'mascot-core-electricien' ),
			'3' => esc_html__( 'Theme Color 3', 'mascot-core-electricien' ),
			'4' => esc_html__( 'Theme Color 4', 'mascot-core-electricien' )
		);
		return $theme_color_list;
	}
}

if(!function_exists('mascot_core_electricien_number_of_theme_colors')) {
	/**
	 * Number of Theme Colors Used in this theme
	 */
	function mascot_core_electricien_number_of_theme_colors() {
		$number_of_theme_colors = 4;
		if( function_exists('electricien_number_of_theme_colors') ) {
			$number_of_theme_colors = electricien_number_of_theme_colors();
		}
		return $number_of_theme_colors;
	}
}

if(!function_exists('mascot_core_electricien_icon_font_packs')) {
	/**
	 * Theme Color list
	 */
	function mascot_core_electricien_icon_font_packs( $icon_type = 'font_awesome' ) {
		$icon_font_packs = array();
		if( function_exists('electricien_icon_font_packs') ) {
			$icon_font_packs = electricien_icon_font_packs()->getIconFontPackByKey($icon_type)->getFileTypeIconList();
		}
		return $icon_font_packs;
	}
}

if(!function_exists('mascot_core_electricien_animate_css_animation_list')) {
	/**
	 * animate.css animation list https://daneden.github.io/animate.css/
	 */
	function mascot_core_electricien_animate_css_animation_list() {
...
if(!function_exists('mascot_core_electricien_custom_animation_class_list')) {
	/**
	 * custom made animation list
	 */
	function mascot_core_electricien_custom_animation_class_list() {
		$class_list = array(
			''	=>	esc_html__( "None", 'mascot-core-electricien' ),
			'fade-in'	=>	esc_html__( "fade-in", 'mascot-core-electricien' ),
			'move-up'	=>	esc_html__( "move-up", 'mascot-core-electricien' ),
			'move-down'	=>	esc_html__( "move-down", 'mascot-core-electricien' ),
			'move-left'	=>	esc_html__( "move-left", 'mascot-core-electricien' ),
			'move-right'	=>	esc_html__( "move-right", 'mascot-core-electricien' ),
			'scale-up'	=>	esc_html__( "scale-up", 'mascot-core-electricien' ),
			'fall-perspective'	=>	esc_html__( "fall-perspective", 'mascot-core-electricien' ),
			'fly'	=>	esc_html__( "fly", 'mascot-core-electricien' ),
			'flip'	=>	esc_html__( "flip", 'mascot-core-electricien' ),
			'helix'	=>	esc_html__( "helix", 'mascot-core-electricien' ),
			'pop-up'	=>	esc_html__( "pop-up", 'mascot-core-electricien' )
		);
		return $class_list;
	}
}

if(!function_exists('mascot_core_electricien_jquery_easings_list')) {
	/**
	 * easings list http://api.jqueryui.com/easings/
	 */
	function mascot_core_electricien_jquery_easings_list() {
...
if(!function_exists('mascot_core_electricien_orderby_parameters_list')) {
	/**
	 * Orderby Parameters list
	 */
	function mascot_core_electricien_orderby_parameters_list() {
		$orderby_parameters_list = array(
			'date'	=>	esc_html__( 'Date', 'mascot-core-electricien' ),
			'name'	=>	esc_html__( 'Post Name', 'mascot-core-electricien' ),
			'rand'	=>	esc_html__( 'Random Order', 'mascot-core-electricien' ),
			'modified'	=>	esc_html__( 'Last Modified Date', 'mascot-core-electricien' ),
			'author'	=>	esc_html__( 'Author', 'mascot-core-electricien' ),
			'title'	=>	esc_html__( 'Title', 'mascot-core-electricien' ),
			'ID'	=>	esc_html__( 'ID', 'mascot-core-electricien' ),
			'parent'	=>	esc_html__( 'Post/Page Parent ID', 'mascot-core-electricien' ),
			'comment_count'	=>	esc_html__( 'Number of Comments', 'mascot-core-electricien' ),
			'menu_order'	=>	esc_html__( 'Page Order', 'mascot-core-electricien' )
		);
		return $orderby_parameters_list;
	}
}

if(!function_exists('mascot_core_electricien_category_orderby_parameters_list')) {
	/**
	 * Category Orderby Parameters list
	 */
	function mascot_core_electricien_category_orderby_parameters_list() {
		$orderby_parameters_list = array(
			esc_html__( 'name', 'mascot-core-electricien' ) 	=> 'name',
			esc_html__( 'id', 'mascot-core-electricien' ) 		=> 'id',
			esc_html__( 'count', 'mascot-core-electricien' ) 	=> 'count',
			esc_html__( 'slug', 'mascot-core-electricien' ) 	=> 'slug',
		);
		return $orderby_parameters_list;
	}
}

if(!function_exists('mascot_core_electricien_isotope_gutter_list')) {
	/**
	 * Gutter list
	 */
	function mascot_core_electricien_isotope_gutter_list() {
		if( mascot_core_electricien_theme_installed() ) {
			return electricien_isotope_gutter_list();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_electricien_different_size_list')) {
	/**
	 * Size list
	 */
	function mascot_core_electricien_different_size_list() {
		if( mascot_core_electricien_theme_installed() ) {
			return electricien_different_size_list();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_electricien_get_post_all_categories_array')) {
	/**
	 * Category List of Blog Posts as an Array
	 */
	function mascot_core_electricien_get_post_all_categories_array() {
		$categories = get_categories( array(
			'orderby' => 'name',
			'order'   => 'ASC'
		) );
		$cats = array();
		$cats[''] = esc_html__( 'All', 'mascot-core-electricien' );
...
if(!function_exists('mascot_core_electricien_get_page_list_array')) {
	/**
	 * Category List of Pages as an Array
	 */
	function mascot_core_electricien_get_page_list_array() {
		$all_pages = get_pages();
		$pages = array();
...
if ( ! function_exists( 'mascot_core_electricien_metabox_get_list_of_predefined_theme_color_css_files' ) ) {
	/**
	 * Get list of Predefined Theme Color css files
	 */
	function mascot_core_electricien_metabox_get_list_of_predefined_theme_color_css_files() {
...
if ( ! function_exists( 'mascot_core_electricien_category_list_array' ) ) {
	/**
	 * Return category list array
	 */
	function mascot_core_electricien_category_list_array( $taxonomy ) {
		$list_categories = array(
			'' => esc_html__( 'All', 'mascot-core-electricien' )
		);
...
if ( ! function_exists( 'mascot_core_electricien_load_styles' ) ) {
	/**
	 * Get style array
	 */
	function mascot_core_electricien_load_styles( $qty = 1, $param_name = 'design_style', $admin_label = false ) {
		$options = array();
		for ($i = 1; $i <= $qty; $i++) {
			$options[sprintf(esc_html__("Style %s", 'mascot-core-electricien'), $i)] = "style{$i}";
		}

		$array = array(
			'type'       => 'dropdown',
			'heading'    => esc_html__('Design Style', 'mascot-core-electricien'),
...
if(!function_exists('mascot_core_electricien_get_btn_design_style')) {
	...
	function mascot_core_electricien_get_btn_design_style() {
		if( mascot_core_electricien_theme_installed() ) {
			return electricien_get_btn_design_style();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_electricien_get_button_size')) {
	...
	function mascot_core_electricien_get_button_size() {
		if( mascot_core_electricien_theme_installed() ) {
			return electricien_get_button_size();
		} else {
			return array();
		}
	}
...
if(!function_exists('mascot_core_electricien_get_post_list_array_by_post_type_old')) {
	/**
	 * Return Post List Array By Post Type
	 */
	function mascot_core_electricien_get_post_list_array_by_post_type_old( $cpt = '', $for_vc = false ) {
		$post_list = array();
		$args = array(
			'post_type'			=> $cpt,
			'posts_per_page'	=> -1,
...
if(!function_exists('mascot_core_electricien_get_post_list_array_by_post_type')) {
	/**
	 * Return Post List Array By Post Type
	 */
	function mascot_core_electricien_get_post_list_array_by_post_type( $cpt = '', $for_vc = false ) {
		$post_list = array();
		$post_list[''] = esc_html__( "Select Item", 'mascot-core-electricien' );
		$args = array(
			'post_type'			=> $cpt,
			'numberposts'		=> -1,
			'orderby'			=> 'title',
...
if(!function_exists('mascot_core_electricien_set_admin_ajax_url')){
	/**
	 * Set admin ajax url via javascript
	 *
	 */
	function mascot_core_electricien_set_admin_ajax_url() {
		echo '<script type="application/javascript">var MascotCoreAjaxUrl = "'.admin_url('admin-ajax.php').'"</script>';
	}
	add_action('wp_enqueue_scripts', 'mascot_core_electricien_set_admin_ajax_url');
}

if(!function_exists('mascot_core_electricien_row_typography')){
	/**
	 * Return Row Typography Array
	 *
	 */
	function mascot_core_electricien_row_typography() {
		$array = array();

		$array = array(
			"type"			=> 'dropdown',
			"heading"		=> esc_html__( "Row Typography", 'mascot-core-electricien' ) ,
			"param_name"	=> "section_typo",
			"description"	=> esc_html__( "Define the color typography of the text of this row.", 'mascot-core-electricien' ) ,
			"value" => array(
				esc_html__( 'Default', 'mascot-core-electricien' ) => '',
				esc_html__( 'Light Typography - on Dark Background', 'mascot-core-electricien' ) => 'section-typo-light',
				esc_html__( 'Dark Typography - on White Background', 'mascot-core-electricien' ) => 'section-typo-dark',
			) ,
			"weight" => "99"
		);
...
if(!function_exists('mascot_core_electricien_base_64_decode')){
	/**
	 * Return urldecode base64_decode
	 *
	 */
	function mascot_core_electricien_base_64_decode($code) {
		return urldecode(base64_decode($code));
	}
}

if(!function_exists('mascot_core_electricien_base_64_decode_raw_html')){
	/**
	 * Return rawurldecode base64_decode
	 *
	 */
	function mascot_core_electricien_base_64_decode_raw_html($code) {
...
if(!function_exists('mascot_core_electricien_get_animation_type')) {
	...
	function mascot_core_electricien_get_animation_type() {
		$array = array(
			...
			esc_html__( 'Floating Animation', 'mascot-core-electricien' )	=>	'tm-animation-floating',
			esc_html__( 'Horizontal Slide Animation', 'mascot-core-electricien' )	=>	'tm-animation-slide-horizontal',

			esc_html__( 'Flicker Animation', 'mascot-core-electricien' )	=>	'tm-animation-flicker',
			esc_html__( 'Spin Animation', 'mascot-core-electricien' )	=>	'tm-animation-spin',


			esc_html__( 'Random Animation 1', 'mascot-core-electricien' )	=>	'tm-animation-random-animation1',
			esc_html__( 'Random Animation 2', 'mascot-core-electricien' )	=>	'tm-animation-random-animation2',
		);
		return $array;
	}
}
...
if(!function_exists('mascot_core_electricien_masonry_image_sizes')) {
	/**
	 * Masonry Image Size list
	 */
	function mascot_core_electricien_masonry_image_sizes() {
		$masonry_image_sizes = array(
			'mascot_core_square'			=> esc_html__( 'Default', 'mascot-core-electricien' ),
			'mascot_core_wide'			=> esc_html__( 'Width', 'mascot-core-electricien' ),
			'mascot_core_height'			=> esc_html__( 'Height', 'mascot-core-electricien' ),
			'mascot_core_width_height'	=> esc_html__( 'Both Width & Height', 'mascot-core-electricien' ),
		);
...
if(!function_exists('mascot_core_electricien_heading_tag_list')) {
	/**
	 * Heading Tag List
	 */
	function mascot_core_electricien_heading_tag_list() {
...
if(!function_exists('mascot_core_electricien_wp_admin_dashicons_list')) {
	/**
	 * WordPress admin Dashicons https://developer.wordpress.org/resource/dashicons
	 */
	function mascot_core_electricien_wp_admin_dashicons_list() {
		$animate_css_animation_list = array(
			'' => '',
...
if ( ! function_exists( 'mascot_core_electricien_prepare_button_classes_from_params' ) ) {
	/**
	 * Return Button Classes Collecting From Params
	 */
	function mascot_core_electricien_prepare_button_classes_from_params( $params = array(), $prefix = '' ) {
		$btn_classes = array();
...
if ( ! function_exists( 'mascot_core_electricien_prepare_header_button_classes_from_params' ) ) {
	/**
	 * Return Header Button Classes Collecting From Params
	 */
	function mascot_core_electricien_prepare_header_button_classes_from_params( $params = array(), $prefix = '' ) {
		$btn_classes = array();
...
if ( ! function_exists( 'mascot_core_electricien_swiper_data_params' ) ) {
	/**
	 * Return Swiper Slider Data Collecting From Params
	 */
	function mascot_core_electricien_swiper_data_params( $params = array(), $prefix = '' ) {
		$swiper_data = array();
...
if(!function_exists('mascot_core_electricien_get_swiper_slider_arraylist')) {
	/**
	 * Return Swiper Slider Array List
	 */
	function mascot_core_electricien_get_swiper_slider_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();

		//Swiper Slider Options
		$control_object->start_controls_section(
			'carousel_options', [
				'label' => esc_html__( 'Carousel/Slider Options', 'mascot-core-electricien' ),
		...
		$control_object->add_responsive_control(
			'list_margin',
			[
				'label' => esc_html__( 'Item Margin', 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			$prefix . "xxl_swiper_items", [
				'label' => esc_html__( "Items Extra Extra Large (Over 1400px)", 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			$prefix . "swiper_items", [
				'label' => esc_html__( "Items Extra Large(Over 1200px)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "lg_swiper_items", [
				'label' => esc_html__( "Items Large (Between 992px to 1200px)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "md_swiper_items", [
				'label' => esc_html__( "Items Medium (Over 768px)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "sm_swiper_items", [
				'label' => esc_html__( "Items Small (Over 576px)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "xs_swiper_items", [
				'label' => esc_html__( "Items Extra Small (Below 576px)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "arrow", [
				'label' => esc_html__( "Show Arrow", 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			$prefix . "bullets", [
				'label' => esc_html__( "Show Pagination/Bullets", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'pagination_type', [
				'label' => esc_html__( "Pagination/Bullets Type", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'bullets' => esc_html__( 'Bullets', 'mascot-core-electricien' ),
					'fraction' => esc_html__( 'Fraction', 'mascot-core-electricien' ),
					'progressbar' => esc_html__( 'Progressbar', 'mascot-core-electricien' ),
				],
				'default' => 'bullets',
				'condition' => [
		...
		$control_object->add_control(
			$prefix . "autoplay", [
				'label' => esc_html__( "Autoplay", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'delay',
			[
				'label' => esc_html__( 'Delay (ms)', 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			$prefix . "loop", [
				'label' => esc_html__( "Infinite Loop", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "centered", [
				'label' => esc_html__( "Enabled Centered", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'space',
			[
				'label' => esc_html__( 'Space (px)', 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			$prefix . 'speed',
			[
				'label' => esc_html__( 'Animation Speed (ms)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => 300,
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "freemod", [
				'label' => esc_html__( "Free Mode", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "reversedir", [
				'label' => esc_html__( "Reverse Direction", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
				'condition' => $dependency
			]
...
if(!function_exists('mascot_core_electricien_get_swiper_slider_nav_arraylist')) {
	/**
	 * Return Owl Slider Nav Array List
	 */
	function mascot_core_electricien_get_swiper_slider_nav_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();
		$control_object->start_controls_section(
			'swiper_arrow_styling', [
				'label' => esc_html__( 'Carousel/Slider Arrow Styling', 'mascot-core-electricien' ),
		...
		$control_object->add_responsive_control(
			"swiper_arrow_display_visibility", [
				'label' => esc_html__( "Visibility (Show/Hide)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'flex' => [
						'title' => __( 'Show', 'mascot-core-electricien' ),
						'icon' => 'eicon-check',
					],
					'none' => [
						'title' => __( 'Hide', 'mascot-core-electricien' ),
						'icon' => 'eicon-ban',
					],
				],
				'default' => 'flex',
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow BG Options', 'mascot-core-electricien' ),
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Color", 'mascot-core-electricien' ),
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Theme Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow Text Options', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Theme Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow Size & Border', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Dimension (Width and Height)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow Opacity', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Opacity', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Theme Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Theme Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Border (Hover)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Opacity (hover)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
...
if(!function_exists('mascot_core_electricien_get_swiper_slider_dots_arraylist')) {
	/**
	 * Return Owl Slider Bullets/Dots List
	 */
	function mascot_core_electricien_get_swiper_slider_dots_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();

		$control_object->start_controls_section(
			'swiper_dots_options', [
				'label' => esc_html__( 'Carousel/Slider Dots Styling', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => $dependency
			]
		);
		$control_object->add_responsive_control(
			$prefix . "dots_display_visibility", [
				'label' => esc_html__( "Visibility in Responsive (Show/Hide)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'block' => [
						'title' => __( 'Show', 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullets/Dots Position', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$control_object->add_control(
			$prefix . 'swiper_dots_pos_center', [
				'label' => esc_html__( "Dots Position Horizontal Center", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => __( 'Vertical Orientation', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
						'title' => __( 'Top', 'mascot-core-electricien' ),
						'icon' => 'eicon-v-align-top',
					],
					'bottom' => [
						'title' => __( 'Bottom', 'mascot-core-electricien' ),
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => __( 'Offset', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => __( 'Horizontal Orientation', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'default' => is_rtl() ? 'right' : 'left',
				'options' => [
					'left' => [
						'title' => __( 'Left', 'mascot-core-electricien' ),
						'icon' => 'eicon-h-align-left',
					],
					'right' => [
						'title' => __( 'Right', 'mascot-core-electricien' ),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullets/Dots BG Options', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Theme Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullet Size', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Color (Active)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Theme Color (Active)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Width (Active)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Height (Active)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
