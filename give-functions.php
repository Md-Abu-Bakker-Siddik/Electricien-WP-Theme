...
function mascot_core_electricien_goal_progress($form_id, $args) {
...
function mascot_core_electricien_give_progress_bar($total_earnings, $total_goal) {
  // Total Earnings.
...
function mascot_core_electricien_give_amount_formatted($amount) {
