...
class TM_Elementor_Header_Cart extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_enqueue_style( 'electricien-woo-shop-mini-cart' );
		wp_enqueue_style( 'tm-header-cart', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/woo/header-cart' . $direction_suffix . '.css' );
		wp_enqueue_script('tm-header-cart', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/js/woo/header-cart.js', array('jquery'), MASCOT_CORE_ELECTRICIEN_VERSION, true);
	}
	...
	public function get_title() {
		return esc_html__( 'Header Cart', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Dropdown Content Style', 'mascot-core-electricien'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'style-dropdown',
                'options' => [
                    'style-dropdown' => esc_html__('Dropdown', 'mascot-core-electricien'),
                    'style-no-dropdown' => esc_html__('No Dropdown Content', 'mascot-core-electricien'),
                    'style-side-panel'    => esc_html__('Side Panel', 'mascot-core-electricien'),
                ],
        ...
        $this->add_control(
            'show_price',
            [
                'label' => esc_html__( 'Hide Price', 'mascot-core-electricien' ),
        ...
        $this->add_control(
            'show_count',
            [
                'label' => esc_html__( 'Hide Count Items Label', 'mascot-core-electricien' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'show_mini_count',
            [
                'label' => esc_html__( 'Hide Mini Count', 'mascot-core-electricien' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'show_dropdown',
            [
                'label' => esc_html__( 'Hide Dropdown', 'mascot-core-electricien' ),
                'type' => Controls_Manager::SWITCHER,
		...
		$this->add_responsive_control(
			'cart_alignment',
			[
				'label' => esc_html__('Cart Alignment', 'mascot-core-electricien'),
		...
		$this->start_controls_section(
			'price_text_options',
			[
				'label' => esc_html__( 'Price Text', 'mascot-core-electricien' ),
        ...
        $this->add_control(
            'count_color',
            [
                'label' => esc_html__('Count Color', 'mascot-core-electricien'),
        ...
        $this->add_control(
            'price_color',
            [
                'label' => esc_html__('Price Color', 'mascot-core-electricien'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		$this->start_controls_section(
			'mini_cart_options',
			[
				'label' => esc_html__( 'Cart FlatIcon', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mini Count', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count BG Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count Text Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count Text Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Count Text Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Item Count Text Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
        ...
        $this->add_responsive_control(
            'icon_bg_size',
            [
                'label'     => esc_html__('Background Size', 'mascot-core-electricien'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 20,
	...
	protected function render() {
		...
		$html = mascot_core_electricien_get_shortcode_shop_template_part( 'header-cart', null, 'header-cart/tpl', $settings, true );
