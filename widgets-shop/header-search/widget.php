...
class TM_Elementor_Header_Search extends Widget_Base {
	public function __construct($data = [], $args = null) {
        ...
        wp_enqueue_script('tm-header-search-popup', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/js/woo/header-search-popup.js', array('jquery'), MASCOT_CORE_ELECTRICIEN_VERSION, true);
	}
	...
	public function get_title() {
		return esc_html__( 'Header Search', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'default',
                'options' => [
                    'default' => esc_html__('Search Form', 'mascot-core-electricien'),
                    'form-cat' => esc_html__('Search Form with Category', 'mascot-core-electricien'),
        ...
        $this->add_control(
            'search_type',
            [
                'label'   => esc_html__('Search Type', 'mascot-core-electricien'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__('Default Search', 'mascot-core-electricien'),
                    'product' => esc_html__('Product Search', 'mascot-core-electricien'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'search_submit_style',
            [
                'label'   => esc_html__('Submit Button Style', 'mascot-core-electricien'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'submit-icon',
                'options' => [
                    'submit-text' => esc_html__('Submit Text', 'mascot-core-electricien'),
                    'submit-icon'    => esc_html__('Submit Icon', 'mascot-core-electricien'),
                ],
                'prefix_class'	=> 'search-',
                'condition' => [
        ...
        $this->add_control(
            'placeholder_text',
            [
                'label' => esc_html__( "Placeholder Text", 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( "Search Product...", 'mascot-core-electricien' ),
                'condition' => [
                    'search_layout!' => 'icon'
                ]
            ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Form', 'mascot-core-electricien'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Option', 'mascot-core-electricien' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Icon', 'mascot-core-electricien'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Input Field Options', 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Input Text Color', 'mascot-core-electricien'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Placeholder Color', 'mascot-core-electricien'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Submit Button Options', 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Submit Search Icon Options', 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Search Icon Color", 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} form button i' => 'color: {{VALUE}};',
                ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Search Icon Color (Hover)", 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'border_color_focus',
            [
                'label'     => esc_html__('Border Color Focus', 'mascot-core-electricien'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Border Focus Theme Colored", 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_electricien_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Form - Input Text', 'mascot-core-electricien'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                        'search_layout' => 'default'
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Form - Submit Button', 'mascot-core-electricien'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                        'search_layout' => 'default'
                ]
        ...
        $this->add_responsive_control(
            'form_submit_bg_size',
            [
                'label'     => esc_html__('Submit Button Background Size', 'mascot-core-electricien'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 20,
        ...
        $this->add_responsive_control(
            'form_submit_pos_top',
            [
                'label'     => esc_html__('Position - Top', 'mascot-core-electricien'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Position - Right', 'mascot-core-electricien'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Icon (Hover)', 'mascot-core-electricien'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} form button:hover i' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( "Border (Hover) Theme Colored", 'mascot-core-electricien' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => mascot_core_electricien_theme_color_list(),
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Icon', 'mascot-core-electricien'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'search_layout' => 'icon'
                ]
	...
	protected function render() {
		...
		$html = mascot_core_electricien_get_shortcode_shop_template_part( 'tpl-search', $settings['search_layout'], 'header-search/tpl', $settings, true );
