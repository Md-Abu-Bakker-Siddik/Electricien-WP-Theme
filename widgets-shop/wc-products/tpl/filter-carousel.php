	...
	<div class="carousel-layout-filter <?php echo esc_attr( $cat_filter_style );?>" data-link-with="<?php echo esc_attr( $holder_id ) ?>">
		<a href="#" class="active" data-filter="*"><?php echo apply_filters( 'mascot_core_electricien_isotope_carousel_filter_all_text', esc_html__( 'All', 'mascot-core-electricien' )); ?></a>
