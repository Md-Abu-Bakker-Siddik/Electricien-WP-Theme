...
<div class="tm-woo-product-block-two">
    <div class="product-inner">
        ...
        <div class="content-box">
            ...
            ?>
            <?php electricien_woocommerce_get_product_short_description($skin_current_theme1_excerpt_length); ?>
            ...
            echo apply_filters( 'woocommerce_loop_add_to_cart_link',
             ...
             $product );
            ?>
            <?php electricien_woocommerce_time_sale_layout_2(); ?>
        </div>
    </div>
</div>
