					...
					<div class="product-wrapper">
						<div class="product-header">
							<?php
								...
								mascot_core_electricien_woocommerce_get_product_label_stock();
							...
							<div class="product-button-holder">
								<?php
								mascot_core_electricien_compare_button();
								mascot_core_electricien_wishlist_button();
								mascot_core_electricien_quickview_button();
								?>
							</div>
						</div>
