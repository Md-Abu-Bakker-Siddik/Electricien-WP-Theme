...
class Skin_Style_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme2', 'mascot-core-electricien' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Icon Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Options (Hover)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme2', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme2' . $direction_suffix . '.css' );
