<?php
namespace MascotCoreElectricien\Widgets\Projects\Skins;
...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme1', 'mascot-core-electricien' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Current Background Styling', 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Icon Styling', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button BG Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button Icon Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Background Styling ( Hover )', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current Icon Styling ( Hover )', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Button Icon Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme1', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme1' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-projects-block-script', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/js/cpt/project-block.js', array('jquery'), false, true );
