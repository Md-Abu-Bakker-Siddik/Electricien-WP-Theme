...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme3', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-project-skin-current-theme3', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/projects/project-skin-current-theme3' . $direction_suffix . '.css' );
