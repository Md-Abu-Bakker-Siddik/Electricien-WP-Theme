<?php
namespace MascotCoreElectricien\Widgets\Blog;
...
class TM_Elementor_Blog extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-blog-style', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/blog/blog-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Blog/News Grid', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$posts_array = mascot_core_electricien_get_post_list_array_by_post_type( 'post' );
		$orderby_parameters_list1 = mascot_core_electricien_orderby_parameters_list();
		$orderby_parameters_list2 = array(
		);
		$orderby_parameters_list = array_merge( $orderby_parameters_list2, $orderby_parameters_list1 );

		$post_meta_array = array(
			'show-post-by-author' =>  esc_html__( 'Show Author', 'mascot-core-electricien' ),
			...
			'show-post-comments-count'  =>  esc_html__( 'Show Comments Count', 'mascot-core-electricien' ),
			'show-post-tag' =>  esc_html__( 'Show Tag', 'mascot-core-electricien' ),
			'show-post-like-button'  =>  esc_html__( 'Show Like Button', 'mascot-core-electricien' )
		);
		...
		$this->add_control(
			'display_type', [
				...
				'options' => [
					...
					'masonry-tiles' =>  esc_html__( 'Masonry Tiles', 'mascot-core-electricien' ),
					'carousel' =>  esc_html__( 'Carousel/Slider', 'mascot-core-electricien' ),
					'basic' =>  esc_html__( 'Basic', 'mascot-core-electricien' ),
					'floating-parallax'  =>  esc_html__( 'Floating Parallax', 'mascot-core-electricien' )
				],
				'default' => 'grid'
			]
		);
		...
		$this->add_control(
			'use_masonry_tiles_featured_image_size', [
				'label' => esc_html__( "Use Predefined Image Size in Masonry Mode", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				"description" => esc_html__( "You can select predefined image size from each items edit page. If you choose yes, then 'Featured Image Size' will not work", 'mascot-core-electricien' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->start_controls_section(
			'query', [
				'label' => esc_html__( 'Query', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'total_items', [
				'label' => esc_html__( "Number of Items to Query from Database", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "How many items do you wish to show? Put -1 to show all. Default 3", 'mascot-core-electricien' ),
				'default' => '3'
			]
		);
		$this->add_control(
			'show_only_selected_single_post', [
				'label' => esc_html__( "Show Only Selected Single Item", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		$this->add_control(
			'selected_single_post', [
				'label' => esc_html__( "Choose Single Item", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => $posts_array,
				'condition' => [
		...
		$this->add_control(
			'ids',
			[
				'label' => __( 'Ids', 'mascot-core-electricien' ),
		...
		$this->add_control(
			'category',
			[
				'label' => __( 'Category', 'mascot-core-electricien' ),
				'type' => Controls_Manager::SELECT2,
		...
		$this->add_control(
			'order_by', [
				'label' => esc_html__( "Order By", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_control(
			'order', [
				'label' => esc_html__( "Order", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'DESC' => esc_html__( 'Descending', 'mascot-core-electricien' ),
					'ASC' => esc_html__( 'Ascending', 'mascot-core-electricien' ),
				],
			]
		);
		...
		$this->start_controls_section(
			'content',
			[
				'label' => esc_html__( 'All Items(Content) Show/Hide', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'show_featured_image', [
				'label' => esc_html__( "Show Featured Image", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'show_excerpt', [
				'label' => esc_html__( "Show Excerpt", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'excerpt_length', [
				'label' => esc_html__( "Excerpt Length", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Number of words to display", 'mascot-core-electricien' ),
				'condition' => [
		...
		$this->add_control(
			'show_post_meta',
			[
				'label' => esc_html__( "Show Post Meta", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'post_meta_options',
			[
				'label' => esc_html__( "Choose Post Meta", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Show This Meta Over Thumbnail", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => $post_meta_array,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text Color (Title Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text Color (Item Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Theme Colored (Title Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Title Theme Colored (Item Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Excerpt Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Post Meta Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Icon Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Single Meta Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Wrapper Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Make BG Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Make BG Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			'cat_filter_section', [
				'label' => esc_html__( 'Category Filter', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		mascot_core_electricien_get_cat_filter_arraylist( $this, 1, array('display_type' => array('grid', 'masonry', 'masonry-tiles', 'carousel') ) );
		mascot_core_electricien_get_cat_filter_arraylist( $this, 2 );
		mascot_core_electricien_get_cat_filter_arraylist( $this, 3 );
		mascot_core_electricien_get_cat_filter_arraylist( $this, 4 );
	...
	protected function render() {
		...
		$settings['holder_id'] = electricien_get_isotope_holder_ID('blog');
	...
	public function render_output( $class_instance, $settings ) {
		...
		$html = mascot_core_electricien_get_cpt_shortcode_template_part( 'blog', $settings['display_type'], 'blog/tpl/type', $settings, true );
