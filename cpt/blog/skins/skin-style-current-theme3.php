...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme3', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme3' . $direction_suffix . '.css' );
