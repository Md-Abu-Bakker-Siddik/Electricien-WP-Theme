...
class Skin_Style_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme2', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme2' . $direction_suffix . '.css' );
