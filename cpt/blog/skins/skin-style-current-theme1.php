...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Border Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme1', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme1' . $direction_suffix . '.css' );
