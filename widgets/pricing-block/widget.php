<?php
namespace MascotCoreElectricien\Widgets\PricingBlock;
...
class TM_Elementor_PricingBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-pricing-block-loader', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/pricing-block/pricing-block-loader' . $direction_suffix . '.css' );
			wp_enqueue_script( 'tm-pricing-block-script', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/js/widgets/pricing-block.js' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Pricing Block', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'pricing_icons_options', [
				'label' => esc_html__( 'Pricing Items', 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'image_position', [
				'label' => esc_html__( "Image/Icon Position", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'right'  =>  esc_html__( "Right", 'mascot-core-electricien' ),
					'left'  =>  esc_html__( "Left", 'mascot-core-electricien' ),
				],
				'default' => 'left',
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Featured Image Section', 'mascot-core-electricien' ),
			...
			[
				...
				'default' => [
					[
						...
						'price' => esc_html__( '$20.00', 'mascot-core-electricien' ),
					],
					[
		...
		$this->add_control(
			'box_animation',
			[
				'label' => esc_html__( "Box Animation Style", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					''  =>  esc_html__( 'No Animation', 'mascot-core-electricien' ),
					'iconbox-style1-current-theme-animation'  =>  esc_html__( 'Style 1 - Current Theme Animation', 'mascot-core-electricien' ),
					'iconbox-style2-border-bottom'  =>  esc_html__( 'Style 2 - Border Bottom', 'mascot-core-electricien' ),
					'iconbox-style3-moving-border-bottom' =>  esc_html__( 'Style 3 - Moving Border Bottom', 'mascot-core-electricien' ),
					'iconbox-style4-bgcolor'  =>  esc_html__( 'Style 4 - Hover BG Color', 'mascot-core-electricien' ),
					'iconbox-style5-moving-bgcolor' =>  esc_html__( 'Style 5 - Hover Moving BG Color', 'mascot-core-electricien' ),
					'iconbox-style6-moving-double-bgcolor'  =>  esc_html__( 'Style 6 - Hover Moving Double BG Color', 'mascot-core-electricien' ),
					'iconbox-style7-hover-moving-border'  =>  esc_html__( 'Style 7 - Hover Moving Border Around Box', 'mascot-core-electricien' ),
				],
				'default' => '',
			]
		);
		...
		$this->add_control(
			'box_shadow_on_hover',
			[
				'label' => esc_html__( "Box Shadow only on Hover?", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		$settings['holder_id'] = electricien_get_isotope_holder_ID('pricing-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_electricien_get_shortcode_template_part( 'pricing', $settings['display_type'], 'pricing-block/tpl', $settings, true );
