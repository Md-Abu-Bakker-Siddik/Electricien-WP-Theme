...
class Skin_Pricing_Style3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Pricing Style3', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-pricing-skin-style3', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/pricing-plan/pricing-skin-style3' . $direction_suffix . '.css' );
