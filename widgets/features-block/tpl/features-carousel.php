		...
		<div class="swiper-container-inner">
			<div class="swiper-wrapper">
				...
				<?php foreach (  $features_items_array as $features_item ) { ?>
					...
					?>
					<div class="swiper-slide elementor-repeater-item-<?php echo $features_item['_id']; ?> <?php echo esc_attr($animation);?>" data-wow-delay="<?php echo esc_attr($animation_delay);?>">
