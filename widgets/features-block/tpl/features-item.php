...
<div class="features-block-style1">
  <div class="inner-box">
    <?php mascot_core_electricien_get_shortcode_template_part( 'part-count', null, 'features-block/tpl', $features_item, false );?>
    <div class="icon-box">
    ...
    <div class="content-box">
      ...
      <?php if ( $show_view_details_button == 'yes' ) : ?>
        <?php mascot_core_electricien_get_shortcode_template_part( 'button', null, 'features-block/tpl', $features_item, false );?>
      <?php endif; ?>
      <?php mascot_core_electricien_get_shortcode_template_part( 'part-featured-image', null, 'features-block/tpl', $features_item, false );?>
    </div>
  </div>
</div>