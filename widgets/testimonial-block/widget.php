<?php
namespace MascotCoreElectricien\Widgets\TestimonialBlock;
...
class TM_Elementor_TestimonialBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-testimonial-block-loader', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/testimonial-block/testimonial-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial Block', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'testimonial_icons_options', [
				'label' => esc_html__( 'Testimonial Items', 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'name',
			[
				'label' => esc_html__( "Author Name", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'position',
			[
				'label' => esc_html__( "Author Position", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( "Designer", 'mascot-core-electricien' ),
			]
		);
		$repeater->add_control(
			'title',
			[
				'label' => esc_html__( "Reason/Title (Optional)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'rating',
			[
				'label' => esc_html__( 'Rating Value', 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'content',
			[
				'label' => esc_html__( "Testimonial Text", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'feature_image',
			[
				'label' => esc_html__( "Author Thumbnail Image", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'feature_image_size',
			[
				'label' => esc_html__( "Choose Thumbnail Image Size", 'mascot-core-electricien' ),
			...
			[
				...
				'default' => [
					[
						...
						'position' => esc_html__( 'position #1', 'mascot-core-electricien' ),
					...
					[
						...
						'position' => esc_html__( 'Title #2', 'mascot-core-electricien' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'mascot-core-electricien' ),
					...
					[
						...
						'position' => esc_html__( 'Title #3', 'mascot-core-electricien' ),
						'featured_image' => Utils::get_placeholder_image_src(),
						'content' => esc_html__( 'Item content. Click the edit button to change this text.', 'mascot-core-electricien' ),
		...
		$this->add_control(
			'icon',
			[
				'label' => __('Testimonial Icon', 'mascot-core-electricien'),
		...
		$this->add_control(
			'icon_image',
			[
				'label' => esc_html__( 'Testimonial Image', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'condition' => [
					'icon_type' => 'image',
				],
		...
		$this->add_control(
			'position_tag',
			[
				'label' => esc_html__( "Position Tag", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_heading_tag_list(),
				'default' => 'div'
			]
		...
		$this->add_control(
			'title_tag',
			[
				'label' => esc_html__( "Reason/Title Tag", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_heading_tag_list(),
				'default' => 'h5'
			]
		...
		$this->add_control(
			'show_author_name', [
				'label' => esc_html__( "Show Author Name", 'mascot-core-electricien' ),
		...
		$this->add_control(
			'show_author_position', [
				'label' => esc_html__( "Show Author Position", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_title', [
				'label' => esc_html__( "Show Reason/Title", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		$this->add_control(
			'show_rating', [
				'label' => esc_html__( "Show Rating", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Author Name Styling', 'mascot-core-electricien' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Author Position Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Author Text Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Reason/Title Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-testimonial-block-style1', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/testimonial-block/testimonial-block-style1' . $direction_suffix . '.css' );
		...
		$settings['holder_id'] = electricien_get_isotope_holder_ID('testimonial-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_electricien_get_shortcode_template_part( 'testimonial', $settings['display_type'], 'testimonial-block/tpl', $settings, true );
