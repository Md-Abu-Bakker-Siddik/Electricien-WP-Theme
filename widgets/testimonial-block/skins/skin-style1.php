<?php
namespace MascotCoreElectricien\Widgets\TestimonialBlock\Skins;
...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style1', 'mascot-core-electricien' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Current Skin Styling', 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'BG Color Options (Hover)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Quote Icon Styling', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Bg Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Bg Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Quote Icon Styling (Hover)', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Bg Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Bg Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Quote Icon Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
