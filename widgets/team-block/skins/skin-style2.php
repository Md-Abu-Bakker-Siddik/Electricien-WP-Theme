<?php
namespace MascotCoreElectricien\Widgets\TeamBlock\Skins;
...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'team-block-style2', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/team-block/team-block-style2' . $direction_suffix . '.css' );
