...
<?php if ( $team_items_array ) : ?>
	<div id="<?php echo esc_attr( $holder_id ) ?>" class="tm-sc-team tm-team-carousel tm-swiper-container" <?php echo html_entity_decode( esc_attr( implode(' ', $swiper_slide_data_info) ) ) ?>>
		<div class="swiper-container-inner">
			<div class="swiper-wrapper">
				...
				<?php foreach (  $team_items_array as $team_item ) { ?>
					...
					?>
					<div class="swiper-slide elementor-repeater-item-<?php echo $team_item['_id']; ?> <?php echo esc_attr($animation);?>" data-wow-delay="<?php echo esc_attr($animation_delay);?>">
						<?php mascot_core_electricien_get_shortcode_template_part( 'team-item', $_skin, 'team-block/tpl', $settings, false ); ?>
					</div>
				<?php } ?>
				<!-- end of the loop -->
			</div>
