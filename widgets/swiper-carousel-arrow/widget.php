...
class TM_Elementor_Swiper_Carousel_Arrow extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-swiper-carousel-arrow', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/swiper-carousel-arrow' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'TM - Swiper Carousel Arrow', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'arrow_style', [
				'label' => esc_html__( "Arrow Style", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'style1'  =>  esc_html__( 'Style 1', 'mascot-core-electricien' ),
					'style2'  =>  esc_html__( 'Style 2', 'mascot-core-electricien' )
				],
				'default' => 'style1'
			]
		);
		...
		$this->start_controls_section(
			'swiper_arrow_styling', [
				'label' => esc_html__( 'Carousel Arrow Styling', 'mascot-core-electricien' ),
	...
	protected function render() {
		...
		$html = mascot_core_electricien_get_shortcode_template_part( 'swiper-carousel-arrow', null, 'swiper-carousel-arrow/tpl', $settings, true );
