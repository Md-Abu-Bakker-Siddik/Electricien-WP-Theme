...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-award-block-skin-style1', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/award-block/award-block-skin-style1' . $direction_suffix . '.css' );
