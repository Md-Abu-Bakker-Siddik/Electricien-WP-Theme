<?php
namespace MascotCoreElectricien\Widgets\ImageGallery;
...
class TM_Elementor_Image_Gallery extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-image-gallery-loader', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/image-gallery/image-gallery-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Image Gallery - Electricien', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'img_min_height',
			[
				'label' => esc_html__( "Image Minimum Height", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'description' => esc_html__( 'Define Columns Layout for Grid/Carousel', 'mascot-core-electricien' ),
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
					'3'  =>  '3',
		...
		$this->start_controls_section(
			'general2',
			[
				'label' => esc_html__( 'Image Collection', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => esc_html__( "Or Maximum Height", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default' => [
					'unit' => 'px',
	...
	protected function render() {
		...
		mascot_core_electricien_wp_enqueue_script_lightgallery();
		...
		$settings['holder_id'] = mascot_core_electricien_get_isotope_holder_ID('gallery');


		$settings['settings'] = $settings;

		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_electricien_get_shortcode_template_part( 'gallery', $settings['display_type'], 'image-gallery/tpl', $settings, true );
