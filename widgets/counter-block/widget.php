<?php
namespace MascotCoreElectricien\Widgets\CounterBlock;
...
class TM_Elementor_CounterBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-counter-block-loader', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Funfact Counter (Electricien)', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'wow_animation_delay',
			[
				'label' => esc_html__( 'Animation Delay', 'mascot-core-electricien' ) . ' (ms)',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Image Custom Width (Only number)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				"description" => esc_html__( "Put custom width of the uploaded image in positive integer value. Example: 120", 'mascot-core-electricien' ),
				'condition' => [
					'icon_type' => array('image')
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::MEDIA,
				"description" => esc_html__( "Upload Icon Bg image", 'mascot-core-electricien' ),
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter Wrapper Style', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-counter-block-style1', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style1' . $direction_suffix . '.css' );
		...
		$html = mascot_core_electricien_get_shortcode_template_part( 'counter-skin-style1', null, 'counter-block/tpl', $settings, true );
