...
class Skin_Style9 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style9', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style9', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style9' . $direction_suffix . '.css' );
