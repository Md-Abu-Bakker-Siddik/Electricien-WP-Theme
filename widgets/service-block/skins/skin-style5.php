...
class Skin_Style5 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style5', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style5', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style5' . $direction_suffix . '.css' );
