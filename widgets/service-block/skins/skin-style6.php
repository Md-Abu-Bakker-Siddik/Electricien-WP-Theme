...
class Skin_Style6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style6', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style6', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style6' . $direction_suffix . '.css' );
