...
class Skin_Style7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style7', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style7', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style7' . $direction_suffix . '.css' );
