...
class Skin_Style4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style4', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style4', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style4' . $direction_suffix . '.css' );
