...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style2', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style2', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style2' . $direction_suffix . '.css' );
