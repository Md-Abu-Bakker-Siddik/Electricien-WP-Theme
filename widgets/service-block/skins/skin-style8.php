...
class Skin_Style8 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style8', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style8', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style8' . $direction_suffix . '.css' );
