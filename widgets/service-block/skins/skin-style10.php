...
class Skin_Style10 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style10', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style10', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style10' . $direction_suffix . '.css' );
