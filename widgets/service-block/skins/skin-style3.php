...
class Skin_Style3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin Style3', 'mascot-core-electricien' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-style3', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style3' . $direction_suffix . '.css' );
