...
?>
	<div class="service-item service-block-style3">
		<div class="inner-box">
			<div class="icon-box">
			...
			<?php mascot_core_electricien_get_shortcode_template_part( 'part-count', null, 'service-block/tpl', $service_item, false );?>
