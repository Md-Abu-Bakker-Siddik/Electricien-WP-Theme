<?php
namespace MascotCoreElectricien\Widgets\ServiceBlock;
...
class TM_Elementor_ServiceBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-service-block-loader', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Service Block', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Service Items', 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Service Icon Section', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$repeater->add_control(
			'icon_type',
			[
				'label' => esc_html__( "Service Icon Type", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$repeater->add_control(
			'service_icon_image',
			[
				'label' => esc_html__( "Icon Type - Image", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( "This image will be shown on the top of the pricing table", 'mascot-core-electricien' ),
				'condition' => [
					'icon_type' => array('image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image Size", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_get_available_image_sizes(),
				'default' => 'full',
				'condition' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Image Custom Width", 'mascot-core-electricien' ),
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'service-block-style1', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/service-block/service-block-style1' . $direction_suffix . '.css' );
		...
		$settings['holder_id'] = electricien_get_isotope_holder_ID('service-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_electricien_get_shortcode_template_part( 'service', $settings['display_type'], 'service-block/tpl', $settings, true );
