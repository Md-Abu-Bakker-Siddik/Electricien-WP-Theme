<?php
namespace MascotCoreElectricien\Widgets\MovingTextRepeater;
...
class TM_Elementor_MovingTextRepeater extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-moving-text-repeater', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/moving-text-repeater/moving-text-repeater' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Moving Text Repeater', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'moving_text_options', [
				'label' => esc_html__( 'Moving Text Items', 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'text',
			[
				'label' => esc_html__( "Moving Text", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'divider_text',
			[
				'label' => esc_html__( "Divider Symbol/Text", 'mascot-core-electricien' ),
		...
		$repeater->add_control(
			'divider_icon',
			[
				'label' => __('Or Divider Icon', 'mascot-core-electricien'),
		...
		$this->add_control(
			'moving_texts_array',
			[
				'label' => esc_html__( "Moving Texts", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'text' => esc_html__( 'Text #1', 'mascot-core-electricien' ),
					],
					[
						'text' => esc_html__( 'Text #2', 'mascot-core-electricien' ),
					],
					[
						'text' => esc_html__( 'Text #3', 'mascot-core-electricien' ),
					],
				],
			]
		);
		...
		$this->add_control(
			'moving_direction', [
				'label' => esc_html__( "Moving Direction", 'mascot-core-electricien' ),
		...
		$this->add_control(
			'text_rotate',
			[
				'label' => esc_html__( 'Rotate Text', 'mascot-core-electricien' ),
		...
		$this->add_control(
			'animation_speed',
			[
				'label' => esc_html__( 'Animation Duration', 'mascot-core-electricien' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mouseover Text Fill Animation', 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Fill Color', 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Text Fill Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			'section_bg_style',
			[
				'label' => esc_html__( 'Background Styling', 'mascot-core-electricien' ),
		...
		$this->start_controls_section(
			'section_style_text',
			[
				'label' => esc_html__( 'Text Styling', 'mascot-core-electricien' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'text_color_normal',
			[
				'label' => esc_html__( 'Fill Color', 'mascot-core-electricien' ),
				'type' => Controls_Manager::COLOR,
		...
		$this->add_control(
			'text_theme_colored',
			[
				'label' => esc_html__( "Fill Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab(
			'text_even_item',
			[
				'label' => esc_html__( 'Even Item', 'mascot-core-electricien' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Divider Styling', 'mascot-core-electricien' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Stroke', 'mascot-core-electricien' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			'divider_even',
			[
				'label' => esc_html__( 'Even', 'mascot-core-electricien' ),
			]
		);
		$this->add_control(
			'divider_fill_even',
