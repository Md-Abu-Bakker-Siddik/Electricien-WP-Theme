...
class TM_Elementor_Top_Primary_Nav extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Header Top Primary Nav', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Menu Items Typography/Color', 'mascot-core-electricien' ),
		...
		$this->add_control(
			'menu_item_color',
			[
				'label' => esc_html__( "Menu Item Color", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Menu Item Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Menu Item Theme Colored", 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Menu Item Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Menu Items Padding/Border Options', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Items Vertical(Top Bottom) Padding', 'mascot-core-electricien' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Item Left Right Padding', 'mascot-core-electricien' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'menu_item_margin',
			[
				'label' => esc_html__( 'Menu Items Margin', 'mascot-core-electricien' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Menu Last Item Padding/Border Options', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown Menu Items Typography/Color', 'mascot-core-electricien' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Dropdown Menu Typography', 'mascot-core-electricien' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Color", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Color (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Text Theme Colored", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Dropdown Menu Text Theme Colored (Hover)", 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => mascot_core_electricien_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Padding/Border Options', 'mascot-core-electricien' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		...
		$settings['holder_id'] = mascot_core_electricien_get_isotope_holder_ID();


		//Primary Navigation Menu Only For This Page
		$settings['custom_primary_nav_menu'] = "";
		if( mascot_core_electricien_theme_active() ) {
			$current_page_id = electricien_get_page_id();
			$settings['custom_primary_nav_menu'] = electricien_get_rwmb_group( 'electricien_' . "page_mb_header_settings", 'custom_primary_nav_menu', $current_page_id );
		}



		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = mascot_core_electricien_get_shortcode_template_part( 'nav1', null, 'header-primary-nav/tpl', $settings, true );
