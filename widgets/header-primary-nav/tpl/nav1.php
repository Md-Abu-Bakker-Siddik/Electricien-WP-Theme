...
<?php
	...
	$enable_one_page_nav_scrolling_effect = electricien_get_rwmb_group( 'electricien_' . "page_mb_header_settings", 'enable_one_page_nav_scrolling_effect', $current_page_id );
