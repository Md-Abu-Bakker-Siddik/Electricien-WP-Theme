<?php
namespace MascotCoreElectricien\Widgets\InteractiveList;
...
class TM_Elementor_InteractiveList extends Widget_Base {
    public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-interactive-list', MASCOT_CORE_ELECTRICIEN_ASSETS_URI . '/css/shortcodes/interactive-list/interactive-list-loader' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Interactive List - Electricien', 'mascot-core-electricien' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'title_section',
			[
				'label' => esc_html__( 'Text Styling Options', 'mascot-core-electricien' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		$html = mascot_core_electricien_get_shortcode_template_part( 'interactive-list-skin-style1', null, 'interactive-list/tpl', $settings, true );
